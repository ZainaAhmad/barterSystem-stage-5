...
import {StyleSheet, Text, View, Image, TextInput,TouchableOpacity, Modal, ScrollView, KeyboardAvoidingView, Keyboard, }from 'react-native';
        ...
        return(
            <View style={styles.container}>
                <View style={{justifyContent:'center',alignItems:'center'}}>
                    ...
                    <View stylle={styles.profileContainer}>
                        ...
                        <View style={styles.buttonContainer}>
                            <TextInput style={styles.loginBox} placeholder={'abc@example.com'} keybaordType={'email-address'} onChangeText={(text)=>{
                                this.setState({
                                    emailId:text
                                })
                            }}/>
